class Extremities_and_adjacencies:
    ...
    def find_adjacency_cycle(self, next_extremity, chromosome, not_telomeres):
        ...
        next_adjacency = Extremities_and_adjacencies.find_next_adjacency(self, next_extremity, chromosome,
                                                                         not_telomeres)
    ...
    def find_chromosomes(self, adjacencies):
        ...
        while len(telomeres) > 0:
            ...
            # else find adjacency cycle
                ...
                adjacency_cycle = Extremities_and_adjacencies.find_adjacency_cycle(self, next_extremity, chromosome,
                                                                                   not_telomeres)
