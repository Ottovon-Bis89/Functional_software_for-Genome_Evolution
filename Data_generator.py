...
class DataGenerator:
    ...
    def generate_intergenic_regions(self, source_genome):
        ...
        The function adds random numbers as intergenic regions (non-coding regions between genes)
        to genes which will be used as identifiers or mutation points for evolutionary events.
    ...
    def check_genes(self, source_genome):
        ...
        If the input is of type Integer then convert to String and return the source genome
        ...
        if all(isinstance(x, int) for x in flattened_src):
            ...
            sys.exit("Inconsistent data types for source genome, check that your input is of a consistent type (such as Integer or String)")
