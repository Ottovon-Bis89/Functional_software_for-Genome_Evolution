class Extremities_and_adjacencies:
    """
    A class that generates the extremities, adjacencies and the different
    ...
    def find_chromosomes(self, adjacencies):
        ...
        while telomeres: # linear chromosomes
        ...
        while not_telomeres:  # if circular chromosomes exist in the genome
