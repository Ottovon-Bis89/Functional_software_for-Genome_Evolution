...
def read_coordinates_from_file(file_path):
    ...
    with open(file_path, 'r') as file:
        for line in file:
            # Strip any leading or trailing whitespace and convert the line to an integer
...
coordinates_file_path = '/home/von/Documents/ch_seq/chrom2_seq.txt'  # provide file path

# Read coordinates from the file
coordinates_of_interest = read_coordinates_from_file(coordinates_file_path)

# Define the output file path
output_file_path = '/home/von/Documents/ch_seq.wig/chrom2_seq.wig'
