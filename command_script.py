...
def run(args):
    ...
    genomeA = data_generator.check_genes(genomeA)
    genomeB = data_generator.check_genes(genomeB)
    genomeA = data_generator.generate_intergenic_regions(genomeA)
    genomeB = data_generator.generate_intergenic_regions(genomeB)
    genomeA = gen_obj.inter_generator(genomeA)
    genomeB = gen_obj.inter_generator(genomeB)
    # print(genomeA)
    # print(genomeB)
